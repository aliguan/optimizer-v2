            ...
            <div className="col-md-2">
              ...
              <div className="col-md-2">
                  <ul className="footer-2">
                      ...
                      <li className="hover-item"><a href="http://meetup.com">Meetup</a></li>
                      <li className="hover-item"> <a href="http://eventbrite.com">Eventbrite</a></li>
                      <li className="hover-item"><a href="http://google.com">Google Places</a></li>
                      <li className="hover-item"><a href="http://seatgeek.com">Seatgeek</a></li>
                      <li className="hover-item"><a href="http://yelp.com">Yelp</a></li>
                  </ul>
              </div>
          </div>
        )
